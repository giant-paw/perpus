...
$routes->group('admin', ['filter' => 'session'], static function (RouteCollection $routes) {
    ...
    // $routes->get('/cetak/(:segment)', 'MembersController::cetak/$1');
    $routes->get('/cetak/(:num)', 'MembersController::cetak/$1');
    ...
    $routes->get('admin/members/(:segment)/print-card', 'MembersController::printCard/$1');
