      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-8 col-xl-9">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control <?php if ($validation->hasError('no_panggil')) : ?>is-invalid<?php endif ?>" id="no_panggil" name="no_panggil" value="<?= $oldInput['no_panggil'] ?? ''; ?>" required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            <label for="classification_number" class="form-label">Nomor Klasifikasi</label>
            <input type="text" class="form-control <?php if ($validation->hasError('no_klasifikasi')) : ?>is-invalid<?php endif ?>" id="no_klasifikasi" name="no_klasifikasi" value="<?= $oldInput['no_klasifikasi'] ?? ''; ?>" required>
            <div class="invalid-feedback">
              <?= $validation->getError('no_klasifikasi'); ?>
            </div>
          </div>
        </div>
      </div>
