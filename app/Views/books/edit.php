      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-8 col-xl-9">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control <?php if ($validation->hasError('no_panggil')) : ?>is-invalid<?php endif ?>" id="no_panggil" name="no_panggil" value="<?= $oldInput['no_panggil'] ?? $book['no_panggil']; ?>" required>
            <div class="invalid-feedback">
              <?= $validation->getError('no_panggil'); ?>
            </div>
          </div>
