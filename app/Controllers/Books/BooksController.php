...
class BooksController extends ResourceController
{
    ...
    public function create()
    {
        if (!$this->validate([
            ...
            'no_panggil' => 'required|string|max_length[255]',
            'no_klasifikasi' => 'required|string|max_length[255]',
        ...
        if (!$this->bookModel->save([
            ...
            'no_panggil' => $this->request->getVar('no_panggil'),
            'no_klasifikasi' => $this->request->getVar('no_klasifikasi'),
    ...
    public function cetak($id)
    {
        ...
        // Load view kartu anggota dengan data member
        $html = view('members/kartu_anggota', ['member' => $member]);

        // Gunakan Dompdf untuk mengonversi HTML ke PDF
        $dompdf = new Dompdf();
        ...
        return $this->response
            ...
            ->setHeader('Content-Disposition', 'attachment; filename="kartu_anggota.pdf"')
